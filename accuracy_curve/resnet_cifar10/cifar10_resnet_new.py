...
# Training parameters
if len(sys.argv) != 4:
    print("usage: >> python cifar10_resnet.py version n epochs")
    sys.exit()
else:
...
save_dir = os.path.join(os.getcwd(), 'saved_models_v%d_n%d'%(version, n))
model_name = 'cifar10_resnet_model.{epoch:02d}.{val_acc:0.6f}.h5'
