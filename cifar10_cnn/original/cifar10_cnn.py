...
if len(sys.argv) != 3:
    print("Usage: >> python cifar10_cnn.py epochs save")
    sys.exit()
else:
...
model_name = 'keras_cifar10_trained_model_' + str(epochs) + '.h5'
...
if not data_augmentation:
    ...
    checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=False, period=15)
