...
def build_resnet_snapshot(x_train, y_train, x_test, y_test, input_shape, batch_size, epochs, num_classes, n, version, M, alpha_zero, name_prefix, data_augmentation=True):
    ...
    callbacks  = snapshot.get_callbacks(model_prefix=name_prefix) # try snapshot callback
